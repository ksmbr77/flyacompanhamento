  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(265 85% 58% / 0.3)" },
          "50%": { boxShadow: "0 0 50px hsl(265 85% 58% / 0.6)" },
        },
        float: {
        ...
        "border-spin": {
          "0%": { borderColor: "hsl(265 85% 58% / 0.3)" },
          "50%": { borderColor: "hsl(265 85% 58% / 0.8)" },
          "100%": { borderColor: "hsl(265 85% 58% / 0.3)" },
        },
        "count-up": {
